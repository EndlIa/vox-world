...
**接口**：`runtimeConfig`、`preferences`、`sceneDocument`、`editorState`、`objectSelection`、`voxelSelection`、`objectTransformSession`、`voxelTransformSession`、`history`、`commandBus`、`editorSession`、`services`、`ports`、`viewModel`、`renderer`、`lifecycle`、`dispose`。
