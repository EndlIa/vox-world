...
- `placement = "new-object"` 在 Object 模式下创建一个新的 `SceneNode + SceneObject`；`parentNodeId` 默认为根节点，`transform` 默认为单位变换。
...
**依赖**：scene-types、domain/voxel/uniform/generator、voxel/uniform/types、util/color、util/result。
