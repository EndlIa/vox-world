...
**依赖**：voxel-transform-command、scene-types、scene-query、scene-patch、scene-document、editor-state、state/voxel/uniform/voxel-selection、state/voxel/uniform/voxel-transform-session、domain/voxel/uniform/selection-strategies、domain/voxel/uniform/symmetry、domain/voxel/uniform/query、util/math、util/result。
